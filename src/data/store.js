...
let projects = [
  {
    ...
    description: 'Update the visuals and layout.',
    created_at: seededAt,
    updated_at: seededAt,
  },
  {
    ...
    description: 'Prepare marketing materials for the upcoming launch.',
    created_at: seededAt,
    updated_at: seededAt,
  },
]
...
let tasks = [
  ...
  },
  {
    ...
    description: 'Replace old images with new high-resolution ones.',
    status: 'todo',
    created_at: seededAt,
    updated_at: seededAt,
  },
  {
    ...
    description: 'Create a compelling email newsletter to announce the launch.',
    status: 'done',
    created_at: seededAt,
    updated_at: seededAt,
  },
